    ...
    >
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          <div>
            ...
            >
              ...
              <span style={{ color: '#888', fontSize: 18 }}>({rows.length} / 25)</span>
            </h1>
          </div>
          ...
          >
            ...
            <tbody>
              {rows.length === 0 && !loading && (
                <tr>
                  <td colSpan={5} style={{ ...tdStyle, textAlign: 'center', color: '#888', padding: 32 }}>
        ...
        <p style={{ marginTop: 16, color: '#666', fontSize: 12 }}>
          Auto-closes at 25 registrations. Use Download CSV to export all entries.
        </p>
      </div>
    </main>
  )
