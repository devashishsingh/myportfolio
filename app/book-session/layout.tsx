...
export const metadata: Metadata = {
  ...
  description: 'Book a 1:1 session with Devashish Singh — mentorship or consulting. Choose your session type, preferred time slot, and timezone.',
  ...
  openGraph: {
    ...
    description: 'Book a 1:1 mentorship or consulting session with Devashish Singh. Flexible slots across all major timezones.',
    url: '/book-session',
  },
}
