    ...
    <header className="header-main">
      ...
      <div className="header-inner container-wide">
        ...
        <div className="header-right">
          ...
          <a href="https://www.linkedin.com/in/devashish-singh-52a050112" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="header-icon header-icon-color">
          ...
          <a href="https://github.com/devashishsingh" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="header-icon header-icon-color">
