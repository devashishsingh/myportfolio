...
const TECH_ICONS: Record<string, JSX.Element> = {
  'VS Code': (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path d="M17.583 2.29L12.6 6.862 7.56 3.042l-.05-.03L2.3 5.75l-.3.18v12.14l.3.18 5.2 2.74.05-.03L12.6 17.14l4.984 4.57 2.116-1.11.3-.16V3.56l-.3-.16-2.117-1.11z" fill="#007ACC"/>
      <path d="M17.583 21.71L12.6 17.14 7.56 20.96l-.05.03-5.21-2.74-.3-.18V5.93l.3-.18L7.51 3.01l.05.03L12.6 6.86l4.984-4.57 2.116 1.11.3.16v16.84l-.3.16-2.117 1.11z" fill="#007ACC" opacity=".8"/>
      <path d="M7.51 3.04L2.3 5.75v12.5l5.21 2.74L12.6 17.14V6.86L7.51 3.04z" fill="#1E6DB4"/>
      <path d="M17.583 2.29L12.6 6.86v10.28l4.984 4.57 2.116-1.11V3.4l-2.117-1.11z" fill="#1E6DB4"/>
    </svg>
  ),
  'GitHub': (
  ...
  'Supabase': (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path d="M13.7 22.3c-.5.6-1.5.2-1.5-.6V13h8.6c.9 0 1.4 1.1.8 1.8L13.7 22.3z" fill="#3ECF8E"/>
      <path d="M13.7 22.3c-.5.6-1.5.2-1.5-.6V13h8.6c.9 0 1.4 1.1.8 1.8L13.7 22.3z" fill="url(#sb)" fillOpacity=".2"/>
      <path d="M10.3 1.7c.5-.6 1.5-.2 1.5.6V11H3.2c-.9 0-1.4-1.1-.8-1.8L10.3 1.7z" fill="#3ECF8E"/>
      <defs><linearGradient id="sb" x1="12.2" y1="14.4" x2="18" y2="18.4" gradientUnits="userSpaceOnUse"><stop stopColor="#249361"/><stop offset="1" stopColor="#3ECF8E"/></linearGradient></defs>
    </svg>
  ),
  'AI Tools': (
  ...
  'Claude': (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" fill="#D4A574"/>
  ...
  'Prisma': (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path d="M21.807 18.285L13.553.756a1.324 1.324 0 0 0-1.129-.754 1.31 1.31 0 0 0-1.206.626L2.408 15.13a1.324 1.324 0 0 0 .168 1.547l6.338 6.67a1.324 1.324 0 0 0 1.33.394l10.93-3.168a1.324 1.324 0 0 0 .633-2.288zM19.36 17.907l-8.828 2.555a.2.2 0 0 1-.248-.268L14.56 4.02a.2.2 0 0 1 .373-.032l5.194 13.27a.2.2 0 0 1-.147.27l-.62.38z" fill="#2D3748"/>
    </svg>
  ),
  'SQLite': (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
      <path d="M21.2 4.4c-.8-.8-2-1.2-3.4-1.2-2.3 0-4.9 1.2-7 3.3-3 3-4.7 7.5-3.7 10.3.4 1.2 1.3 2 2.5 2.4.4.1.8.2 1.2.2 1.8 0 3.9-1 5.8-2.9 3-3 4.7-7.5 3.7-10.3-.3-.7-.6-1.3-1.1-1.8z" fill="#0F80CC"/>
      <path d="M9.1 16.8c-.7-2 .4-5.3 2.7-8.1.5-.6 1.1-1.2 1.7-1.7-.3-.1-.6-.1-.9-.1-2 0-4.2 1-5.9 2.8-2.5 2.5-3.9 6.2-3.1 8.5.3 1 1.1 1.7 2.1 2 .3.1.7.2 1 .2 1.1 0 2.3-.5 3.4-1.4-.4-.6-.7-1.4-1-2.2z" fill="#003B57"/>
    </svg>
  ),
  'Tailwind CSS': (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
...
export default function ProjectCard({ title, category, excerpt, href = '#', github, tech, cta = 'View' }: Props) {
  return (
    <motion.article
      className="group"
      whileHover={{ rotateY: 4, rotateX: -2, scale: 1.03, boxShadow: '8px 16px 40px rgba(0,0,0,0.12)' }}
      transition={{ type: 'spring', stiffness: 260, damping: 20 }}
      style={{ perspective: '800px', transformStyle: 'preserve-3d' }}
    >
      <div className="card-3d block border project-card-inner">
